...
export async function POST(req: Request) {
    ...
    - Important: Make sure For each important decision in gameplay allow the user to decide a choice then ask the user to role the dice, once the dice is rolled user will input what they rolled back into the chat.  Use your extensive knowledge of gameplay to determine what happens.
    ...
    Do not:
    - Allow user to input a choice that is numbered that wasnt given to you.  
