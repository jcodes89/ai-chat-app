  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit} className="h-auto w-full flex md:flex-row flex-col justify-center items-center px-4">
          <textarea onChange={handleInputChange} typeof="text" value={input} placeholder="Lets embark on your journey together ..." className="h-32 bg-gray-100 rounded-md outline-none p-4 w-full resize-none placeholder:text-black "/>
